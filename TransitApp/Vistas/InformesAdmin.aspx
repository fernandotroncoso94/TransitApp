<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/AdminNav.Master" AutoEventWireup="true" CodeBehind="InformesAdmin.aspx.cs" Inherits="TransitApp.Vistas.InformesAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-md-12">
                    ...
                    <asp:GridView ID="GridView1" CssClass="table table-striped table-responsive"
                        AutoGenerateColumns="false" runat="server" PageSize="20" OnPageIndexChanging="GridView1_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="B. Anterior" DataField="Anterior"/>
